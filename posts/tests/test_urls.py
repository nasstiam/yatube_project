...
class PostsURLTests(TestCase):
    ...
    def test_urls_uses_correct_template(self):
        ...
        # для неавторизованное и авторизованное пользователя
        ...
        # для авторизованное пользователя
        response_comment = self.authorized_client.get(f'/posts/{PostsURLTests.post.id}/comment/')
        self.assertTemplateUsed(response_comment, 'posts/add_comment.html')
